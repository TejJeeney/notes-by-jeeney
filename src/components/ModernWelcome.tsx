...
export function ModernWelcome() {
  ...
  return (
    <div className="h-full flex items-center justify-center p-8 bg-gradient-to-br from-white/60 via-blue-50/60 to-indigo-100/60 dark:from-slate-800/60 dark:via-slate-700/60 dark:to-slate-900/60 backdrop-blur-sm">
      <div className="max-w-4xl text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="group p-8 bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200/60 dark:border-slate-700/60 hover:shadow-2xl hover:scale-105 transition-all duration-300 animate-fade-in"
        ...
        <Button 
          ...
          size="lg"
          className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 hover:from-indigo-600 hover:via-purple-600 hover:to-pink-600 text-white shadow-2xl hover:shadow-3xl transition-all duration-300 px-12 py-4 text-xl font-semibold rounded-2xl hover:scale-105 animate-scale-in"
        >
